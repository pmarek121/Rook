...
ItemRarity_t Item::getRarityId() {
	...
	return static_cast<ItemRarity_t>(boost::get<int64_t>(value));
}
...
void Item::updateRarityFrame()
{
	...
	container->updateThing(this, getID(), getItemCount());
}
